<div>
  <img align="left" width="44px" src="https://github.com/Thumos96/VPKEdit/blob/main/res/brand/logo_512.png?raw=true" alt="VPKEdit Logo" />
  <h1>VPKEdit</h1>
</div>
...
<div>
  <a href="https://github.com/Thumos96/VPKEdit/blob/main/LICENSE" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/github/license/Thumos96/VPKEdit?label=license" alt="License" /></a>
  <a href="https://github.com/Thumos96/VPKEdit/actions" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/github/actions/workflow/status/Thumos96/VPKEdit/build.yml?branch=main&label=builds" alt="Workflow Status" /></a>
  ...
  <a href="https://ko-fi.com/Thumos96" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/donate-006dae?label=ko-fi&logo=ko-fi" alt="Ko-Fi" /></a>
</div>

<div>
  <img width="400px" src="https://github.com/Thumos96/VPKEdit/blob/main/res/brand/screenshot1.png?raw=true" alt="A screenshot of VPKEdit with a VPK and an MDL preview open in wireframe mode." />
  <img width="400px" src="https://github.com/Thumos96/VPKEdit/blob/main/res/brand/screenshot2.png?raw=true" alt="A screenshot of VPKEdit with a VPK and an MDL preview open in shaded textured mode." />
</div>
<div>
  <img width="400px" src="https://github.com/Thumos96/VPKEdit/blob/main/res/brand/screenshot3.png?raw=true" alt="A screenshot of VPKEdit with a BSP and a VTF preview open." />
  <img width="400px" src="https://github.com/Thumos96/VPKEdit/blob/main/res/brand/screenshot4.png?raw=true" alt="A screenshot of the command-line version of VPKEdit." />
</div>

## Installing

Please read [this file](https://github.com/Thumos96/VPKEdit/blob/main/INSTALL.md) for step-by-step installation instructions. VPKEdit is available for Windows 7+ and
...
Please read [this file](https://github.com/Thumos96/VPKEdit/blob/main/CONTROLS.md) to see all keyboard shortcuts.

A separate application with no external dependencies (`vpkeditcli`) provides a command-line interface.

## Planned Features

See [the open issues on this repository marked as an enhancement](https://github.com/Thumos96/VPKEdit/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement).
